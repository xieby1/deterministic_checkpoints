...
, gcpt-bin
  ...
  stage1-profiling = pkgs.callPackage ../checkpoints/1.profiling.nix {
    inherit qemu nemu gcpt-bin;
  };
  simpoint = pkgs.callPackage ../simpoint {};
  stage2-cluster = pkgs.callPackage ../checkpoints/2.cluster.nix {
    inherit simpoint stage1-profiling;
  };
  stage3-checkpoint = pkgs.callPackage ../checkpoints/3.checkpoint.nix {
